...
class GoodsController extends Controller{
    ...
    */
    public function good_list(Request $request){
        ...
        $list = $model
            ->alias('p')
            ->field('p.id,p.name,p.category,p.isXg,p.price,p.stock,p.market_price,p.unit,p.spec,p.price_line,p.cover,p.sort,pc.title')
    ...
    */
    public function detail(Request $request){
        ...
        $info = $model
            ->alias('p')
            ->field('p.id,p.name,p.category,p.isXg,p.price,p.stock,p.market_price,p.unit,p.spec,p.content,p.price_line,p.cover,p.sort,pc.title')
            ->join('product_category pc', 'p.category = pc.id', 'LEFT')
