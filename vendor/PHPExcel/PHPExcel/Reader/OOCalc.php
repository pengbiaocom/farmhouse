...
class PHPExcel_Reader_OOCalc extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	public function canRead($pFilename)
	{
		...
		if (!file_exists($pFilename)) {
			return;//throw new PHPExcel_Reader_Exception("Could not open " . $pFilename . " for reading! File does not exist.");
		}
...
//		}
	...
	public function listWorksheetNames($pFilename)
	{
		...
		if (!$zip->open($pFilename)) {
			return;//throw new PHPExcel_Reader_Exception("Could not open " . $pFilename . " for reading! Error opening file.");
		}
